    ...
    <div className="mt-5">
      {showData === true ? (
        <div className="container">
          <div className="card mb-10 mx-auto bg-dark text-light ">
            <div className="row g-0">
              <div className="col-md-4">
                ...
                <img
                  src="https://images.pexels.com/photos/11195535/pexels-photo-11195535.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
        ...
        <h2 className="text-dark ">No Data</h2>
      )}
    </div>
  );
};
